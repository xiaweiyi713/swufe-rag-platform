"""Final runtime builder with production QueryPlan normalization."""
...
def build_local_query_plan_runtime(
    ...
    *,
    ...
    runtime.planner = ProductionQuestionPlanner(runtime.academic_db)
    return runtime
...
def build_request_query_plan_runtime(
    ...
    *,
    ...
    runtime.planner = ProductionQuestionPlanner(
