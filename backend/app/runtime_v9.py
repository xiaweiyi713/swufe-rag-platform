"""Final runtime with full-school evidence repair."""
...
from academic_audit.structured_executor_v5 import execute as execute_structured_v5
...
orchestration.execute_structured = execute_structured_v5
