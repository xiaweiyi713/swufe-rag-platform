"""Production runtime with full-catalog planning and repaired SQL evidence."""
...
from academic_audit.structured_executor_v3 import execute as execute_structured_v3
...
from swufe_rag.query_plan_catalog_v5 import CourseAwareQuestionPlanner


# QueryPlanRuntime resolves this module-level callable.  Rebinding it here
# upgrades the executor without duplicating the orchestration implementation.
orchestration.execute_structured = execute_structured_v3
...
def build_request_query_plan_runtime(
    ...
    *,
    ...
    runtime.planner = CourseAwareQuestionPlanner(
