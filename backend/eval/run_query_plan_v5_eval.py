"""Final 100-question audit on runtime v7."""

from __future__ import annotations

import json

from app.runtime_v7 import build_local_query_plan_runtime
...
def main() -> None:
    ...
    for index, case in enumerate(cases, 1):
        ...
        try:
            result = runtime.handle_question(
                question,
                cohort="2023",
                session_id=f"benchmark-v5-{case['id']}",
            )
    ...
    target = OUTPUT.parent / "query-plan-v5-eval"
