    ...
    def get_runtime():
        with lock:
            if state["runtime"] is None:
                ...
                state["runtime"] = build_local_query_runtime(
...
def main() -> None:
    ...
    uvicorn.run("app.server.application:app", host="127.0.0.1", port=8000, reload=False)


__all__ = ["AcademicAuditRequest", "AskRequest", "app", "create_app", "main"]
